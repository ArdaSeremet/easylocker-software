  ...
  methods: {
    ...
    handleSubmit() {
      ...
      if (this.username.length <= 0) {
        this.modalText = "Invalid username. Please try again.";
        setTimeout(() => {
      ...
      CONFIG.db.query(
        ...
        (err, res) => {
          ...
          if (res.length <= 0) {
            this.modalText = "This username isn't registered in this locker.";
            setTimeout(() => {
              this.modalShow = false;
            }, 3000);
            return;
          ...
          this.modalText = "User is found. Please wait...";
          this.$router.push({
